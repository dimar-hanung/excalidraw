...
export function init(
  ...
  // 2. | 撤销 | 重做 | 格式刷 | 清除格式 |
  const undoDom = container.querySelector<HTMLDivElement>(".menu-item__undo")!;
  undoDom.title = `撤销(${isApple ? "⌘" : "Ctrl"}+Z)`;
  undoDom.onclick = function () {
    instance.command.executeUndo();
  };

  const redoDom = container.querySelector<HTMLDivElement>(".menu-item__redo")!;
  redoDom.title = `重做(${isApple ? "⌘" : "Ctrl"}+Y)`;
  redoDom.onclick = function () {
    instance.command.executeRedo();
  };

  const painterDom = container.querySelector<HTMLDivElement>(
    ".menu-item__painter",
  )!;
  ...
  container.querySelector<HTMLDivElement>(".menu-item__format")!.onclick =
    function () {
      instance.command.executeFormat();
    };

  // 3. | 字体 | 字体变大 | 字体变小 | 加粗 | 斜体 | 下划线 | 删除线 | 上标 | 下标 | 字体颜色 | 背景色 |
  const fontDom = container.querySelector<HTMLDivElement>(".menu-item__font")!;
  ...
  const sizeSetDom =
    container.querySelector<HTMLDivElement>(".menu-item__size")!;
  ...
  const sizeAddDom = container.querySelector<HTMLDivElement>(
    ".menu-item__size-add",
  )!;
  ...
  const sizeMinusDom = container.querySelector<HTMLDivElement>(
  ...
  const boldDom = container.querySelector<HTMLDivElement>(".menu-item__bold")!;
  ...
  const italicDom =
    container.querySelector<HTMLDivElement>(".menu-item__italic")!;
  italicDom.title = `斜体(${isApple ? "⌘" : "Ctrl"}+I)`;
  italicDom.onclick = function () {
    instance.command.executeItalic();
  };

  const underlineDom = container.querySelector<HTMLDivElement>(
  ...
  const strikeoutDom = container.querySelector<HTMLDivElement>(
  ...
  const superscriptDom = container.querySelector<HTMLDivElement>(
  ...
  const subscriptDom = container.querySelector<HTMLDivElement>(
  ...
  const colorControlDom = container.querySelector<HTMLInputElement>("#color")!;
  colorControlDom.oninput = function () {
    instance.command.executeColor(colorControlDom.value);
  };
  const colorDom =
    container.querySelector<HTMLDivElement>(".menu-item__color")!;
  ...
  const highlightControlDom =
    container.querySelector<HTMLInputElement>("#highlight")!;
  highlightControlDom.oninput = function () {
    instance.command.executeHighlight(highlightControlDom.value);
  };
  const highlightDom = container.querySelector<HTMLDivElement>(
  ...
  const titleDom =
    container.querySelector<HTMLDivElement>(".menu-item__title")!;
  ...
  titleOptionDom.onclick = function (evt) {
    const li = evt.target as HTMLLIElement;
    const level = li.dataset.level as any;
    instance.command.executeTitle(level || null);
  };

  const leftDom = container.querySelector<HTMLDivElement>(".menu-item__left")!;
  ...
  const centerDom =
    container.querySelector<HTMLDivElement>(".menu-item__center")!;
  ...
  const rightDom =
    container.querySelector<HTMLDivElement>(".menu-item__right")!;
  rightDom.title = `右对齐(${isApple ? "⌘" : "Ctrl"}+R)`;
  rightDom.onclick = function () {
    instance.command.executeRowFlex(RowFlex.RIGHT);
  };

  const alignmentDom = container.querySelector<HTMLDivElement>(
  ...
  const justifyDom = container.querySelector<HTMLDivElement>(
    ".menu-item__justify",
  )!;
  ...
  const rowMarginDom = container.querySelector<HTMLDivElement>(
  ...
  const listDom = container.querySelector<HTMLDivElement>(".menu-item__list")!;
  ...
  const tableDom =
    container.querySelector<HTMLDivElement>(".menu-item__table")!;
  const tablePanelContainer = container.querySelector<HTMLDivElement>(
    ".menu-item__table__collapse",
  )!;
  const tableClose = container.querySelector<HTMLDivElement>(".table-close")!;
  const tableTitle = container.querySelector<HTMLDivElement>(".table-select")!;
  const tablePanel = container.querySelector<HTMLDivElement>(".table-panel")!;
  // 绘制行列
  ...
  const imageDom =
    container.querySelector<HTMLDivElement>(".menu-item__image")!;
  const imageFileDom = container.querySelector<HTMLInputElement>("#image")!;
  ...
  const hyperlinkDom = container.querySelector<HTMLDivElement>(
  ...
  const separatorDom = container.querySelector<HTMLDivElement>(
  ...
  const pageBreakDom = container.querySelector<HTMLDivElement>(
  ...
  const watermarkDom = container.querySelector<HTMLDivElement>(
  ...
  const codeblockDom = container.querySelector<HTMLDivElement>(
  ...
  const controlDom = container.querySelector<HTMLDivElement>(
    ".menu-item__control",
  )!;
  ...
  const checkboxDom = container.querySelector<HTMLDivElement>(
    ".menu-item__checkbox",
  )!;
  ...
  const radioDom =
    container.querySelector<HTMLDivElement>(".menu-item__radio")!;
  ...
  const latexDom =
    container.querySelector<HTMLDivElement>(".menu-item__latex")!;
  ...
  const dateDom = container.querySelector<HTMLDivElement>(".menu-item__date")!;
  ...
  const blockDom =
    container.querySelector<HTMLDivElement>(".menu-item__block")!;
  ...
  // 5. | 搜索&替换 | 打印 |
  const searchCollapseDom = container.querySelector<HTMLDivElement>(
    ".menu-item__search__collapse",
  )!;
  const searchInputDom = container.querySelector<HTMLInputElement>(
    ".menu-item__search__collapse__search input",
  )!;
  const replaceInputDom = container.querySelector<HTMLInputElement>(
    ".menu-item__search__collapse__replace input",
  )!;
  const searchDom =
    container.querySelector<HTMLDivElement>(".menu-item__search")!;
  ...
  const printDom =
    container.querySelector<HTMLDivElement>(".menu-item__print")!;
  ...
  const editorOptionDom =
    container.querySelector<HTMLDivElement>(".editor-option")!;
  ...
  async function updateCatalog() {
    ...
    const catalogMainDom =
      container.querySelector<HTMLDivElement>(".catalog__main")!;
  ...
  const catalogDom = container.querySelector<HTMLElement>(".catalog")!;
  const catalogModeDom =
    container.querySelector<HTMLDivElement>(".catalog-mode")!;
  const catalogHeaderCloseDom = container.querySelector<HTMLDivElement>(
  ...
  const pageModeDom = container.querySelector<HTMLDivElement>(".page-mode")!;
  ...
  container.querySelector<HTMLDivElement>(".page-scale-percentage")!.onclick =
    function () {
      instance.command.executePageScaleRecovery();
    };

  container.querySelector<HTMLDivElement>(".page-scale-minus")!.onclick =
    function () {
      instance.command.executePageScaleMinus();
    };

  container.querySelector<HTMLDivElement>(".page-scale-add")!.onclick =
    function () {
      instance.command.executePageScaleAdd();
    };

  // 纸张大小
  const paperSizeDom = container.querySelector<HTMLDivElement>(".paper-size")!;
  ...
  const paperDirectionDom =
    container.querySelector<HTMLDivElement>(".paper-direction")!;
  ...
  const paperMarginDom =
    container.querySelector<HTMLDivElement>(".paper-margin")!;
  ...
  // 全屏
  const fullscreenDom = container.querySelector<HTMLDivElement>(".fullscreen")!;
  ...
  const modeElement = container.querySelector<HTMLDivElement>(".editor-mode")!;
  ...
  // 模拟批注
  const commentDom = container.querySelector<HTMLDivElement>(".comment")!;
  async function updateComment() {
    const groupIds = await instance.command.getGroupIds();
    for (const comment of context.commentList || []) {
  ...
  instance.listener.visiblePageNoListChange = function (payload) {
    ...
    container.querySelector<HTMLSpanElement>(".page-no-list")!.innerText = text;
  };
  ...
  instance.listener.intersectionPageNoChange = function (payload) {
    container.querySelector<HTMLSpanElement>(".page-no")!.innerText = `${
      payload + 1
    }`;
  };
  ...
  instance.listener.controlChange = function (payload) {
    ...
    disableMenusInControlContext.forEach((menu) => {
      const menuDom = container.querySelector<HTMLDivElement>(
        `.menu-item__${menu}`,
      )!;
  ...
  const handleContentChange = async function () {
    ...
    container.querySelector<HTMLSpanElement>(".word-count")!.innerText = `${
      wordCount || 0
    }`;
    // 目录
    if (isCatalogShow) {
  ...
  instance.listener.saved = function (payload) {
    console.debug("elementList: ", payload);
  };
