import type { ImageDisplay } from "../dataset/enum/Common";
import type { EditorMode, EditorZone } from "../dataset/enum/Editor";
import type { IElement, IElementPosition } from "./Element";
